    ...
    <footer className="bg-white">
      <div className="mx-auto max-w-screen-xl px-4  sm:px-6  lg:px-8 ">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <ul className="mb-5 flex gap-6">
              ...
              <li>
                <a
                  href="https://github.com/nhantam2502/curanest-fe-capstone"
                  rel="noreferrer"
                  target="_blank"
                  className="text-gray-700 transition hover:opacity-75"
                >
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-2">
            <div className="mt-5">
              <p className="font-medium text-gray-900 text-xl">Công ty</p>
            ...
            <div className="mt-5">
              <p className="font-medium text-gray-900 text-xl">Liên kết hữu ích</p>
              ...
              <ul className="mt-6 space-y-4 text-lg">
                ...
                <li>
                  <a
                    href="mailto:curanest.nursingcare@gmail.com"
                    className="text-gray-700 transition hover:opacity-75"
                  >
        ...
        <p className="mb-5 text-lg text-gray-500">
          © 2022. CURANEST. Đã đăng ký bản quyền.
        </p>
      </div>
    </footer>
  );
