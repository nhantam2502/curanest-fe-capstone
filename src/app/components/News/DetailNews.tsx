...
const DetailNews = ({ post }: DetailNewsProps) => {
  ...
  return (
    <div className="relative bg-[url('/hero-bg.png')] bg-no-repeat bg-center bg-cover bg-fixed py-12">
      ...
      <div className="max-w-[1600px] mx-auto  px-8 py-8">
        <article className=" rounded-xl shadow-sm p-8 mb-16">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {relatedPosts.map((relatedPost) => (
              <Link href={`/guest/news/${relatedPost.id}`} key={relatedPost.id}>
